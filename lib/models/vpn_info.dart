class VpnInfo {
  ...
  late final String base640OpenVPNConfigurationData;
  ...
  VpnInfo({
    ...
    required this.base640OpenVPNConfigurationData,
  });
  ...
  VpnInfo.fromJSON(Map<String, dynamic> jsonData) {
    ...
    base640OpenVPNConfigurationData =
  ...
  Map<String, dynamic> toJson() {
    ...
    jsonData['OpenVPN_ConfigData_Base64'] = base640OpenVPNConfigurationData;
    return jsonData;
  }
}
